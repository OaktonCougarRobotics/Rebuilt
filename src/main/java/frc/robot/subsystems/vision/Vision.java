...
public final class Vision extends SubsystemBase {
    ...
    public void periodic(){
        ...
        if(!visionOn /* has vision been disabled? */|| Math.abs(drivetrain.swerveDrive.getFieldVelocity().omegaRadiansPerSecond) >= Constants.MAX_STABLE_ANGULAR_VELOCITY /* is the bot rotating too fast? */) return;
